 ...
 */
package cn.micromoving.bcp.modules.gen.web;
...
import cn.micromoving.bcp.modules.gen.service.GenSchemeService;
import cn.micromoving.bcp.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("cn.micromoving.bcp.modules");
		}
