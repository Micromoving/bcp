 ...
 */
package cn.micromoving.bcp.modules.act.utils;
...
import cn.micromoving.bcp.common.annotation.FieldName;
import cn.micromoving.bcp.common.config.Global;
import cn.micromoving.bcp.common.utils.Encodes;
import cn.micromoving.bcp.common.utils.ObjectUtils;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_LEAVETEXT = new String[]{"myProcess", "my_process"};
	public static final String[] PD_TEST_AUDIT = new String[]{"test_audit", "oa_test_audit"};
	public static final String[] PD_HR_LEAVE = new String[]{"leave_V1.0", "hr_attendance"};
	public static final String[] PD_HR_SALARY = new String[]{"salary", "hr_salary_instance"};
	public static final String[] PD_HR_PERFORMANCE = new String[]{"performance_act","hr_report_record"};
	public static final String[] PD_HR_PERFORMANCE_2 = new String[]{"performance_act_2","hr_report_record"};
	public static final String[] PD_HR_DUTY = new String[]{"DutyDetail","hr_report_record"};
	public static final String[] PD_HR_WORKLOAD_1 = new String[]{"reportedWorkloade1","hr_report_record"};
	public static final String[] PD_HR_WORKLOAD_2 = new String[]{"reportedWorkloade2","hr_report_record"};
	public static final String[] PD_HR_DEGREEEDU = new String[]{"degreeEdu","hr_degree_edu"};
	public static final String[] PD_HR_TRAIN_EXPERIENCE = new String[]{"trainProcess","hr_train_experience"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
