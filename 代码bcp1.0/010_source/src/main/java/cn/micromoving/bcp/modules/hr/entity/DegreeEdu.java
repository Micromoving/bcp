...
public class DegreeEdu extends ActEntity<DegreeEdu> {
	...
	/* 恢复工资时间 字符串*/
	private String recoverSalaryDateString;
	/* 是否延期 */
	private String isDelay;
	/* 取得证书时间 */
	private Date getCertificateDate;
	/* 取得证书时间字符串 */
	private String getCertificateDateString;
	/* 毕业证编号 */
	...
	public String getStartDateString() {
		this.startDateString = DateUtils
                .formatDate(startDate, Global.getConfig("web.dateFormat"));
	...
	public String getEndDateString() {
		this.endDateString = DateUtils
                .formatDate(endDate, Global.getConfig("web.dateFormat"));
	...
	public String getLoanDateString() {
		this.loanDateString = DateUtils
                .formatDate(loanDate, Global.getConfig("web.dateFormat"));
	...
	public String getWipeoutDateString() {
		this.wipeoutDateString = DateUtils
                .formatDate(wipeoutDate, Global.getConfig("web.dateFormat"));
        return this.wipeoutDateString;
	}
	...
	public String getRecoverSalaryDateString() {
		this.recoverSalaryDateString = DateUtils
                .formatDate(recoverSalaryDate, Global.getConfig("web.dateFormat"));
        return this.recoverSalaryDateString;
	}

	public void setRecoverSalaryDateString(String recoverSalaryDateString) {
		this.recoverSalaryDate = StringUtils.toDate(recoverSalaryDateString, Global.getConfig("web.dateFormat"));
	}

	public String getGetCertificateDateString() {
		this.getCertificateDateString = DateUtils
                .formatDate(getCertificateDate, Global.getConfig("web.dateFormat"));
        return this.getCertificateDateString;
	}

	public void setGetCertificateDateString(String getCertificateDateString) {
		this.getCertificateDate = StringUtils.toDate(getCertificateDateString, Global.getConfig("web.dateFormat"));
	}
