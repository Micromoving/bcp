...
public class InsuredSituationService extends CrudService<InsuredSituationDao, InsuredSituation>{
    ...
    public List<InsuredSituation> findAllList(InsuredSituation insuredSituation) {
        insuredSituation.getSqlMap().put("dsf", dataScopeFilter(insuredSituation.getCurrentUser(), "o", "a"));
        List<InsuredSituation> insuredSituationList = dao.findAllList(insuredSituation);
        return insuredSituationList;
    }
}
