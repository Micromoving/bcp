...
public class RecruitmentService extends
    ...
    public List<Recruitment> findAllList(Recruitment recruitment) {
        recruitment.getSqlMap().put("dsf", dataScopeFilter(recruitment.getCurrentUser(), "o", "a"));
        List<Recruitment> recruitmentList = dao.findAllList(recruitment);
