...
<script type="text/javascript">
	function exportExcel() {
		$("#inputForm").attr("action", "${ctx}/hr/classTeacherFee/import");
		$("#inputForm").submit();
		return false;
	}
</script>
					...
					<div class="module">
						...
						<div class="module-body">
							<form:form class="form-horizontal row-fluid" id="inputForm"
								enctype="multipart/form-data" modelAttribute="classTeacherFee"
								action="${ctx}/hr/classTeacherFee/import" method="post">
								...
								<div class="stream-composer media">
									<div class="media-body">
										<div class="clearfix">
											<a id="btnExport"
												href="${ctx}/hr/classTeacherFee/downloade"
