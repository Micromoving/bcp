						...
						<div class="module">
							...
							<div class="module-body">
								...
								<div class="control-group" style="height:20px;">
									${degreeEdu.user.name }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;工号：${degreeEdu.user.loginName }
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${fns:getOfficeRootName(degreeEdu.employee.office.id)}<br>
									<br>
								</div>
								<form:form class="form-horizontal row-fluid" id="inputForm"
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:select tabindex="1" class="span8 required" path="isOffjob">
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:input class="span8 required" path="startDateString"
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:input class="span8 required" path="endDateString"
												onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"></form:input>
										</div>
									</div>
									<!--/报考是否盖章-->
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:select tabindex="1" class="span8 required" path="hasSalary">
												<form:options items="${fns:getDictList('yes_no')}"
													itemLabel="label" itemValue="value" htmlEscape="false" />
											</form:select>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:select tabindex="1" class="span8 required" path="isDelay">
												<form:options items="${fns:getDictList('yes_no')}"
													itemLabel="label" itemValue="value" htmlEscape="false" />
											</form:select>
										</div>
