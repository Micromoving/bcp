...
<script type="text/javascript">
	function page(n, s) {
		...
		if (s)
			$("#pageSize").val(s);
		$("#searchForm").attr("action", "${ctx}/hr/degreeEdu/middle");
		$("#searchForm").submit();
		return false;
	}
</script>
							...
							<div class="module-body">
								...
								<div class="stream-list">
									<div class="media stream">
										<form:form id="searchForm" action="${ctx}/hr/degreeEdu/middle"
											...
											<div class="control-group">
												...
												&nbsp;&nbsp;&nbsp;<a href="#"
													...
													onclick="return page('','','${ctx}/hr/degreeEdu/middle');">
													查询 </a>
											</div>
										</form:form>
									</div>
											...
											<tbody>
												<c:forEach var="employeeData" items="${employeepage.list}"
													...
													<tr>
														...
														<td><a
															href="${ctx}/hr/degreeEdu/form?user.id=${employeeData.id}">学历教育</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
