										...
										<div class="clearfix">
											...
											<c:if test="${empty status}">
												...
												<shiro:hasPermission name="hr:reportedWorkloade:audit">
													<c:set value='<%=request.getParameter("flag") %>' var="flag"></c:set>
													<c:if test="${flag ne 0|| empty flag}">
														...
														<c:forEach varStatus="status" var="data" items="${list}">
															<tr>
																...
																<td><input type="text" class="p25"
																	name="teachingList[${status.index }]"
																	value="${data.teaching}"></td>
																<td><input type="text" class="p25"
																	name="dissertationList[${status.index }]"
																	value="${data.dissertation}"></td>
																<td><input type="text" class="p25"
																	name="tutorialSystemList[${status.index }]"
																	value="${data.tutorialSystem}"></td>
																<td><input type="text" class="p25"
																	name="optionalList[${status.index }]"
																	value="${data.optional}"></td>
																<td><input type="text" class="p25"
																	name="termPaperList[${status.index }]"
																	value="${data.termPaper}"></td>
																<td><input type="text" class="p25"
																	name="markingList[${status.index }]"
																	value="${data.marking}"></td>
																<td><input type="text" class="p25"
																	name="theTopicList[${status.index }]"
																	value="${data.theTopic}"></td>
																<td><input type="text" class="p25"
																	name="invigilatorList[${status.index }]"
																	value="${data.invigilator}"></td>
																<td><input type="text" class="p25"
																	name="smallClassDiscussionList[${status.index }]"
																	value="${data.smallClassDiscussion}"></td>
																<td><input type="text" class="p25"
																	name="allKindsOfCompetitionList[${status.index }]"
																	value="${data.allKindsOfCompetition}"></td>
																<td><input type="text" class="p25"
																	name="otherList[${status.index }]"
																	value="${data.other}"></td>
																<td><input type="text" class="p25"
