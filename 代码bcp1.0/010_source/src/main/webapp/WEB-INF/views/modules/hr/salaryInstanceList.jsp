											...
											<c:forEach items="${page.list}" var="data" varStatus="status">
												<div class="stream-headline">
													...
													<div class="stream-text">
														...
														<c:if test="${empty data.act.taskName && not empty data.procInsId}">已完成</c:if>
														<br> 工资信息： [
														<c:forEach items="${data.salaryInstanceTaskList}"
															var="datatask" varStatus="status">
															<c:if test="${datatask.salaryItems.salaryType eq '1'}">
																${datatask.salaryItems.salaryItemsName}<c:if
												...
												<div class="stream-options">
													...
													<a
														...
														target="_blank" class="btn btn-small"> 工资详情 </a> <a
														href="${ctx}/hr/specialDataProcessing/list?salaryInstanceId=${data.id}"
														target="_blank" class="btn btn-small"> 特殊人员数据处理</a>
												</div>
											</c:forEach>
