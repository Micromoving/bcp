											...
											<tbody>
												...
												<tr>
													<td width="8%">
														...
														<div class="control-group" name="post_level"
															style="text-align:center">项目</div>
													</td>
													<td colspan="4" style="text-align:center"><div
															class="control-group">普通职员</div></td>
													<td colspan="3" style="text-align:center"><div
															class="control-group">中级职员</div></td>
													<td colspan="2" style="text-align:center"><div
															class="control-group">高级职员</div></td>
												</tr>
												<tr>
													<td width="8%">
														<!--/级别-->
														...
														<div class="control-group" name="professional_level"
															style="text-align:center">级别</div>
													</td>
													<td style="text-align:center"><div
															class="control-group">九级</div></td>
													<td style="text-align:center"><div
															class="control-group">八级</div></td>
													<td style="text-align:center"><div
															class="control-group">七级</div></td>
													<td style="text-align:center"><div
															class="control-group">六级</div></td>
													<td style="text-align:center"><div
