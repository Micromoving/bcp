								...
								<div class="stream-list">
									<div class="media stream">
										<form:form id="searchForm"
											action="${ctx}/hr/trainExperience/middle"
											modelAttribute="trainExperience" class="form-horizontal row-fluid"
											method="post">
											...
											<div class="control-group">
												...
												&nbsp;&nbsp;&nbsp;<a href="#"
													...
													onclick="return page('','','${ctx}/hr/trainExperience/middle');">
													查询 </a>
											</div>
										</form:form>
									</div>
											...
											<tbody>
												<c:forEach var="employeeData" items="${employeepage.list}"
													...
													<tr>
														...
														<td><a
															href="${ctx}/hr/trainExperience/form?user.id=${employeeData.id}">培训</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
