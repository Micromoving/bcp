	...
	<!--/增加按钮-->
								<div class="stream-composer media">
									<div class="media-body">
										<div class="clearfix">
											<input id="assignButton" class="btn btn-primary pull-right" type="submit" value="分配角色"/>
	...
	<sys:message content="${message}"/>
		...
		<script type="text/javascript">
			$("#assignButton").click(function(){
				top.$.jBox.open("iframe:${ctx}/sys/role/usertorole?id=${role.id}", "分配角色",810,520,{
								...
								<div class="media stream">
									<div class="container-fluid breadcrumb">
										...
										<div class="row-fluid span8">
											...
											<span class="span4">数据范围:
												${fns:getDictLabel(dictvalue, 'sys_data_scope', '')}</span>
										</div>
									</div>
									<sys:message content="${message}" />
								</div>
