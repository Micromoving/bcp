				...
				<div class="formbar t-line">
					...
					<div class="form">
						...
						<form:form class="form-horizontal row-fluid" id="inputForm"
							modelAttribute="certificateInformation" action="${ctx}/hr/cert/form2"
							method="post">
							...
							<div class="formbar t-line">
								...
								<a class="btn-con" href="${ctx }/hr/cert/list">返回</a>
							</div>
						</form:form>
					</div>
					<div class="wxts">
