							...
							<div class="module-body">
								...
								<form:form class="form-horizontal row-fluid" id="inputForm"
									...
									<div class="stream-list">
										<div class="media stream">
											<div class="control-group">
												攻读学历:${fns:getDictLabel(degreeEdu.diploma,'diploma',"")} <br> <br>
												攻读学位:${fns:getDictLabel(degreeEdu.degree,'degree',"")}&nbsp;&nbsp;&nbsp;&nbsp;攻读方式:
												${fns:getDictLabel(degreeEdu.eduMode,'edu_mode',"")}<br> <br>
												攻读类型:${fns:getDictLabel(degreeEdu.eduType,'edu_type',"")}&nbsp;&nbsp;&nbsp;&nbsp;是否脱产:${fns:getDictLabel(degreeEdu.isOffjob,'yes_no',"")}
												<br> <br>
												协议签订情况:${degreeEdu.signAgreement }${fns:getDictLabel(degreeEdu.signAgreement,'yes_no',"")}&nbsp;&nbsp;&nbsp;&nbsp;攻读最短年限:${degreeEdu.ageLimit }
												<br> <br> 攻读院校:${degreeEdu.school}&nbsp;&nbsp;&nbsp;&nbsp;攻读专业:${degreeEdu.major }&nbsp;&nbsp;&nbsp;&nbsp;专业攻读方向:${degreeEdu.researchArea }
												<br> <br> 攻读开始时间:${fns:formatDate("yyyy年MM月",degreeEdu.startDate)}&nbsp;&nbsp;&nbsp;&nbsp;攻读完成时间:${fns:formatDate("yyyy年MM月",degreeEdu.endDate)}
												<br> <br> 报考是否盖章:${fns:getDictLabel(degreeEdu.isConfirm,'yes_no',"")}&nbsp;&nbsp;&nbsp;&nbsp;学费:${degreeEdu.tuition }
												<br> <br> 借款金额:${degreeEdu.loan }&nbsp;&nbsp;&nbsp;&nbsp;借款时间:${degreeEdu.loanDate }
												<br> <br> 报销金额:${degreeEdu.wipeout }&nbsp;&nbsp;&nbsp;&nbsp;报销时间:${degreeEdu.wipeoutDate }
												<br> <br> 启动读研(博)工资:${fns:getDictLabel(degreeEdu.hasSalary,'yes_no',"")}&nbsp;&nbsp;&nbsp;&nbsp;恢复工资时间:${fns:formatDate("yyyy年MM月",degreeEdu.recoverSalaryDate)}
												<br> <br> 是否延期:${fns:getDictLabel(degreeEdu.isDelay,'yes_no',"")}&nbsp;&nbsp;&nbsp;&nbsp;取得证书时间:${fns:formatDate("yyyy年MM月",degreeEdu.getCertificateDate)}
