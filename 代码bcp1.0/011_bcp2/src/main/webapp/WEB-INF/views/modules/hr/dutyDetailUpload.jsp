...
<script type="text/javascript">
	function exportExcel() {
		$("#inputForm").attr("action", "${ctx}/hr/dutyDetail/import");
		$("#inputForm").submit();
		return false;
	}
</script>
						...
						<div class="module">
							...
							<div class="module-body">
								...
								<form:form id="inputForm" class="form-horizontal row-fluid"
									...
									action="${ctx}/hr/dutyDetail/import" method="post">
									...
									<div class="stream-composer media">
										<div class="media-body">
											<div class="clearfix">
												<a id="btnExport"
													href="${ctx}/hr/dutyDetail/export?reportRecord.id=${dutyDetail.reportRecord.id}"
