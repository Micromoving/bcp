										...
										<div class="clearfix">
											<shiro:hasPermission name="hr:empPerformanceLevel:import">
												<c:if
													...
													<a href="${ctx }/hr/empPerformanceLevel/upload"
													...
													<c:forEach varStatus="status" var="data" items="${list}">
														<tr>
															...
															<td><input type="hidden"
																...
																value="${data.user.id}"> <input type="radio"
																${data.performanceLevel eq '1'?" checked=\"checked\"":"" }
																value="1" name="performanceLevelList[${status.index}]">一档
																...
																name="performanceLevelList[${status.index}]">三档</td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
