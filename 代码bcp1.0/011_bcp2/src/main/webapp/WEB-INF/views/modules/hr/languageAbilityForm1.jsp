        ...
        <div class="row bg-grey">
            ...
            <div class="formbar">
                <b class="b-left-20"><a href="${ ctx}/home">首页</a>&nbsp;>&nbsp;<a
						...
						href="${ctx }/hr/languageAbility/list">工作经历</a>
                    &nbsp;>&nbsp;<a href="${ctx }/hr/languageAbility/form1">新增工作经历</a> </b>
            </div>
            <!-- 内容 -->
            <div class="formbar t-line">
                ...
                <div class="form">
                   ...
                   <form:form class="form-horizontal row-fluid" id="inputForm"
							modelAttribute="languageAbility" action="${ctx}/hr/languageAbility/form2"
							method="post">
                        ...
                        <div class="formbar t-line">
                            ...
                            <a class="btn-con" href="${ctx }/hr/languageAbility/form1">返回</a>
                        </div>
                    </form:form>
                </div>
                <div class="wxts">
