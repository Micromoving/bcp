		...
		<div class="container">
			<div class="row">
				...
				<div class="span9">
                    ...
                    <tbody>
                      <tr>
                        <td colspan="7" style="text-align:center"><div><b>(非在编专任教师)系列工资标准</b></div></td>
                      </tr>
                      <tr>
                        <td width="8%" colspan="2"><!--/级别-->
                          
                          <div class="control-group" name="duties_level" style="text-align:center">级别</div></td>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center"><div class="control-group">一级</div></td>
												...
												<tr>
													<td colspan="7">备注：岗位津贴，每学期末完成标准课时量后发放的岗位津贴（每学期末发放，一年发放两次）</td>
												</tr>
											</tbody>
										</table>
										<br>
