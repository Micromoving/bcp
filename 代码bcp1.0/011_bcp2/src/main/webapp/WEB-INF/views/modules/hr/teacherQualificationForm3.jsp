							...
							<table class="dttable step3-tbl wtd-step3">
								<tbody>
									<tr>
										...
										<td>${teacherQualification.user.loginName}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>教师资格种类：</strong></td>
										<td>${fns:getDictLabel(teacherQualification.certificateTypes,'sy_certificate_types'," ")}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>教师资格证号码：</strong></td>
										<td>${teacherQualification.certificationNumber}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>任教学科：</strong></td>
										<td>${teacherQualification.teachingSubjects}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>证书颁发日期：</strong></td>
										<td>${teacherQualification.certificateIssueDateString}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>颁发机构：</strong></td>
										<td>${teacherQualification.issuingAgency}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>申请单位：</strong>
										<td>${teacherQualification.applicationUnit}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>审核时间：</strong>
										<td>${teacherQualification.auditDateString}</td>
									</tr>
									<tr>
										<td class="step3-td"><strong>备注：</strong>
										<td>${teacherQualification.remark}</td>
									</tr>
								</tbody>
							</table>
						</div>
