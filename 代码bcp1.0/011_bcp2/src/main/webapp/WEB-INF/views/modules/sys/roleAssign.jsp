		...
		<div class="container">
			<div class="formbar">
				<b><a href="${ctx}/home">首页</a>&nbsp;&gt;&nbsp;<a
						...
						href="${ctx }/sys/role/assign?id=${role.id}">分配角色</a></b>
			</div>
			<div class="formbar t-line">
				<input id="assignButton" class="btn-con" type="submit" value="分配角色" />
			</div>
				...
				$("#assignButton")
						.click(
								function() {
									top.$.jBox
											.open(
													"iframe:${ctx}/sys/role/usertorole?id=${role.id}",
													"分配角色",
													810,
													520,
													{
														...
														submit : function(v, h,
																f) {
															var pre_ids = h
																	.find("iframe")[0].contentWindow.pre_ids;
															var ids = h
																	.find("iframe")[0].contentWindow.ids;
				...
				<div class="container-fluid breadcrumb">
					<div class="row-fluid span12">
						<span class="span4">角色名称: <b>${role.name}</b></span> <span
							class="span4">归属机构: ${role.office.name}</span> <span
							class="span4">英文名称: ${role.enname}</span>
					</div>
