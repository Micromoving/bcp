			...
			<div class="row" style="background:#f6f6f6;">
				...
				<div class="formbar">
					<b><a href="${ctx}/home">首页</a>&nbsp;&gt;&nbsp;<a
						...
						href="${ctx }/sys/role">角色管理</a>&nbsp;&gt;&nbsp;<a
						href="${ctx}/sys/role/form">新增角色</a></b>
				</div>
				<div class="form">
					<form:form id="inputForm" modelAttribute="role"
						...
						<div class="input_common">
							<div class="mb15">
								<label class="title g5">归属部门:</label>
								<sys:treeselect id="office" name="office.id"
									value="${role.office.id}" labelName="office.name"
									labelValue="${role.office.name}" title="部门"
									url="/sys/office/treeData" cssClass="h30 w300" />
							</div>
							<div class="mb15">
								<label class="title g5">角色名称:</label><input id="oldName"
									name="oldName" type="hidden" value="${role.name}">
								<form:input path="name" htmlEscape="false"
									class="h30 w300 required" />
							</div>
							<div class="mb15">
								<label class="title g5">英文名称:</label><input id="oldEnname"
									name="oldEnname" type="hidden" value="${role.enname}">
							...
							<div class="mb15">
								<label class="title g5">角色类型:</label>
								<form:select path="roleType" class="h30 w300">
							...
							<div class="mb15">
								<label class="title g5">系统数据:</label>
								<form:select path="sysData" class="h30 w300">
									<form:options items="${fns:getDictList('sy_yes_no')}"
										itemLabel="label" itemValue="value" htmlEscape="false" />
								</form:select>
								<span class="help-inline">“是”表示只有超级管理员能进行修改，“否”表示拥有角色修改人员的权限能进行修改</span>
							</div>
							<div class="mb15">
								<label class="title g5">是否可用</label>
								<form:select path="useable" class="h30 w300">
									<form:options items="${fns:getDictList('sy_yes_no')}"
										itemLabel="label" itemValue="value" htmlEscape="false" />
								</form:select>
							...
							<div class="mb15">
								<label class="title g5">数据范围:</label>
								<form:select path="dataScope" class="h30 w300">
							...
							<div class="mb15">
								<label class="title g5" style="vertical-align:top;">角色授权:</label>
								<div id="menuTree" class="ztree"
									style="margin-top:3px;display:inline-block;"></div>
								<form:hidden path="menuIds" />
								<div id="officeTree" class="ztree"
									style="display:inline-block;margin-top:3px;"></div>
								<form:hidden path="officeIds" />
							</div>
							<div class="mb15">
								<label class="title g5">备注:</label>
								<form:textarea path="remarks" htmlEscape="false" rows="3"
									maxlength="200" class="h30 w300" />
							</div>
							<div class="formbar t-line form-bar-left">
								<c:if
									...
									<input id="btnSubmit" class="btn-con btn-sub btn-big-ft"
										type="submit" value="保 存" />&nbsp;
										</c:if>
								<input id="btnCancel" class="btn-con btn-sub btn-big-ft"
