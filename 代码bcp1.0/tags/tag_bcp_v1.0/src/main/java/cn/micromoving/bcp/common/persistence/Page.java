 ...
 */
package cn.micromoving.bcp.common.persistence;
...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("<input id=\"pNo\" style=\"width:30px;\" class=\"span1\"  type=\"input\" value=\""+pageNo+"\" size=\"1\"/>");
		sb.append("页&nbsp;&nbsp;");
		sb.append("<a href=\"javascript:\" class=\"btn btn-primary\" onclick=\""+funcName+"(document.getElementById('pNo').value,"+pageSize+",'"+funcParam+"');\">"
                + "确定</a>");
		sb.append("</div></div>");
