 ...
 */
package cn.micromoving.bcp.common.service;
...
import cn.micromoving.bcp.common.persistence.BaseEntity;
					...
					if (!dataScope.contains(r.getDataScope())
						...
						if (Role.DATA_SCOPE_ALL.equals(r.getDataScope())) {
							...
							sqlString.append(" OR (" + oa + ".parent_id = '"
								...
								.getDataScope())) {
							if ("2".equals(user.getOffice().getGrade())) {
								sqlString.append(" OR " + oa + ".id = '"
										+ user.getOffice().getId() + "'");
								sqlString.append(" OR " + oa
										+ ".parent_ids LIKE '"
										+ user.getOffice().getParentIds()
										+ user.getOffice().getId() + ",%'");

							} else if ("3".equals(user.getOffice().getGrade())) {
								sqlString.append(" OR " + oa + ".id = '"
										+ user.getOffice().getId() + "'");
								sqlString.append(" OR " + oa + ".id= '"
										+ user.getOffice().getParentId() + "'");
