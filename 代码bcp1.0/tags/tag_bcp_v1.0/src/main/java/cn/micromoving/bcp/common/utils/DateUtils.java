...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * @return 取得指定格式的生日。
	 */
	public static String getBirthDateByIDCard(String idNo,String pattern){
	...
	/**
	 * 判断注册截止日期是否超过了当前日期
	 * @param deadLineRegister
	 * @return
	 * @throws Exception
	 */
	public static boolean isdeadLineRegister(String deadLineRegister) throws Exception{
		SimpleDateFormat fmt = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date systemDate = new Date();
		Date deadLineRegisterDate = fmt.parse(deadLineRegister);
		if(systemDate.getTime()>=deadLineRegisterDate.getTime()){
			return true;
		}
		return false;
