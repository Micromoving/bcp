...
import cn.micromoving.bcp.modules.hr.entity.SalaryInstancePerformance;
...
@MyBatisDao
public interface SalaryInstancePerformanceDao extends CrudDao<SalaryInstancePerformance> {
