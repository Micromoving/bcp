...
import cn.micromoving.bcp.common.utils.CookieUtils;
import cn.micromoving.bcp.common.utils.DateUtils;
import cn.micromoving.bcp.common.utils.IdGen;
import cn.micromoving.bcp.common.utils.StringUtils;
import cn.micromoving.bcp.common.web.BaseController;
import cn.micromoving.bcp.modules.sys.entity.User;
import cn.micromoving.bcp.modules.sys.security.FormAuthenticationFilter;
...
public class LoginController extends BaseController {
    ...
    public String home(HttpServletRequest request, HttpServletResponse response) {
        request.getSession().removeAttribute("employee.id");
        request.getSession().removeAttribute("menuIds");
    ...
    public String index(HttpServletRequest request, HttpServletResponse response) {
        ...
        User currentUser = UserUtils.getByLoginName(principal.getLoginName());
        /* 2:注册用户。在招聘管理中，跳转至简历信息表单页。 */
    ...
    public String getThemeInCookie(@PathVariable
    String theme, HttpServletRequest request, HttpServletResponse response) {
