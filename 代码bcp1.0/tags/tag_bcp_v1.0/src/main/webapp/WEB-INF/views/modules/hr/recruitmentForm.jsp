							...
							<div class="module-body">
								<form:form class="form-horizontal row-fluid" id="inputForm"
									  ...
									  <div class="control-group">
										...
										<div class="controls">
											<sys:treeselect id="office" name="office.id"
												...
												dataMsgRequired="recruitment"
												labelValue="${fns:getOfficeRootName(recruitment.user.office.id)}" title="部门"
												url="/sys/office/treeData?type=2" cssClass="input-xxxlarge"
												allowClear="true" allowInput="true" notAllowSelectParent="false" />
										</div>
									</div> 
									<!--
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<form:select path="duties" id="duties"
											 class="span8">
